...
$TCA['tx_schulungen_domain_model_schulung'] = [
		...
		'types' => [
				'1' => ['showitem' => 'sys_language_uid;;;;1-1-1,titel,untertitel,kategorie,sort_index,beschreibung;;;richtext[]:rte_transform[mode=ts_css|imgpath=uploads/tx_patenschaften/rte/],voraussetzungen,treffpunkt,dauer,veranstalter,teilnehmer_min,teilnehmer_max,contact,anmeldung_deaktiviert,termine_versteckt'],
		],
		'palettes' => [
				'1' => ['showitem' => ''],
		],
		'columns' => [
				...
				'kategorie' => [
						...
						'config' => [
								'type' => 'select',
								'items' => [
										['LLL:EXT:schulungen/Resources/Private/Language/locallang_db.xml:tx_schulungen_domain_model_schulung.kategorie.0', 0],
										['LLL:EXT:schulungen/Resources/Private/Language/locallang_db.xml:tx_schulungen_domain_model_schulung.kategorie.1', 1],
										['LLL:EXT:schulungen/Resources/Private/Language/locallang_db.xml:tx_schulungen_domain_model_schulung.kategorie.2', 2],
										['LLL:EXT:schulungen/Resources/Private/Language/locallang_db.xml:tx_schulungen_domain_model_schulung.kategorie.3', 3],
										['LLL:EXT:schulungen/Resources/Private/Language/locallang_db.xml:tx_schulungen_domain_model_schulung.kategorie.4', 4]
								],
						],
				],
				'termine_versteckt' => [
