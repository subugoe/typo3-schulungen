...
class Tx_Schulungen_Controller_BenachrichtigungController extends Tx_Extbase_MVC_Controller_ActionController {
	 ...
	 */
	public function injectTermine(Tx_Schulungen_Domain_Repository_TerminRepository $terminRepository) {
...
//                $this->settings = array();
//                $this->settings['mail']['fromMail'] = 'zentralinfo@sub.uni-goettingen.de';
//                $this->settings['mail']['fromMail'] = 'dominic.simm@sub.uni-goettingen.de';
//                $this->settings['mail']['fromName'] = 'SUB Zentralinformation';
